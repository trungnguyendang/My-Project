...
import vn.edu.usth.se.model.a2.kengine.Doc;
import vn.edu.usth.se.model.a2.kengine.DocCnt;
import vn.edu.usth.se.model.a2.kengine.Engine;
import vn.edu.usth.se.model.a2.kengine.Query;
...
public class ProgStudentMan {
  ...
  public Student createStudent(Object[] data) throws NotPossibleException{
	   ...
	   *    throws NotPossibleException 
	   */
	  Student tempStudent = new Student((int) data[0], (String) data[1], (String) data[2], (String) data[3]);
	  if(tempStudent.repOK()) {
		  return tempStudent;
	  }
	  else {
		  throw new NotPossibleException("Invalid data for Student object.");
	  }
}
  ...
  public UndergradStudent createUndergradStudent(Object[] data) throws NotPossibleException{
	  ...
	  Student tempUndergradStudent = new Student((int) data[0],(String) data[1],(String) data[2],(String) data[3]);
	  if(tempUndergradStudent.repOK()) {
		  return (UndergradStudent) tempUndergradStudent;
	  }else {
		  throw new NotPossibleException("Invalid data for UndergradStudent object");
	  }
  ...
  public PostgradStudent createPostgradStudent(Object[] data) throws NotPossibleException {
	...
	Student tempPostgradStudent = new Student((int) data[0],(String) data[1],(String) data[2],(String)data[3]);
	if (tempPostgradStudent.repOK()) {
		return (PostgradStudent) tempPostgradStudent;
	}else {
		throw new NotPossibleException("Invalid data for PostgradStudent");
	}
  }
  ...
  public void addStudent(Student c) {
		 ...
		 */
	 Doc tempDoc = new Doc(c.toHTMLDoc());
	 this.objects.add(c);
	 this.engine.addDocs(tempDoc.toString());
}
  /**
  ...
  public Query search(String[] words) throws NotPossibleException {
	    if (words == null || words.length <= 0)
	      throw new NotPossibleException("ProgStudentMan: invalid data: " + Arrays.toString(words));
	    ...
	    try {
	      ...
	      throw new NotPossibleException("ProgStudentMan: queries not found: " + Arrays.toString(words));
	    }
	    return q;
	  }
}
